...
Hy3TabBarEntry::Hy3TabBarEntry(Hy3TabBar& tab_bar, Hy3Node& node): tab_bar(tab_bar), node(node) {
	g_pAnimationManager->createAnimation(0.0F, this->focused, g_pConfigManager->getAnimationPropertyConfig("fadeSwitch"), AVARDAMAGE_NONE);
	// this->focused
	//     .create(0.0f, g_pConfigManager->getAnimationPropertyConfig("fadeSwitch"), AVARDAMAGE_NONE);
	//

	g_pAnimationManager->createAnimation(0.0F, this->urgent, g_pConfigManager->getAnimationPropertyConfig("fadeSwitch"), AVARDAMAGE_NONE);
	// this->urgent
	//     .create(0.0f, g_pConfigManager->getAnimationPropertyConfig("fadeSwitch"), AVARDAMAGE_NONE);
	//
	// this->offset
	//     .create(-1.0f, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	g_pAnimationManager->createAnimation(-1.0F, this->offset, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	//
	// this->width
	//     .create(-1.0f, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	g_pAnimationManager->createAnimation(-1.0F, this->width, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	//
	// this->vertical_pos
	//     .create(1.0f, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	
	g_pAnimationManager->createAnimation(1.0F, this->vertical_pos, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	//
	// this->fade_opacity
	//     .create(0.0f, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	g_pAnimationManager->createAnimation(0.0F, this->fade_opacity, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
...
Hy3TabBar::Hy3TabBar() {
	g_pAnimationManager->createAnimation(1.0f, this->fade_opacity, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	// this->fade_opacity
	//     .create(1.0f, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
...
Hy3TabGroup::Hy3TabGroup(Hy3Node& node) {
	...
	g_pAnimationManager->createAnimation(Vector2D(0, 0), this->pos, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	
	// this->size.create(g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
	g_pAnimationManager->createAnimation(Vector2D(0, 0), this->size, g_pConfigManager->getAnimationPropertyConfig("windowsMove"), AVARDAMAGE_NONE);
